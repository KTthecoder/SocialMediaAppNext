...
const FriendHorizontal = (props: Props) => {
  return (
    <div className='flex flex-row items-start justify-start mb-7'>
      {props.profileImg != null ? <Image width={0} height={0} sizes={'100%'} className='w-3/12 aspect-square rounded-md sm:w-[70px]' src={props.profileImg?.toString()} alt={props.profileImgAlt != null ? props.profileImgAlt?.toString() : ''}/>
