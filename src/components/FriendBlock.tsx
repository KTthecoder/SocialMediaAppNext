...
const FriendBlock = (props: Props) => {
  ...
  const acceptInvite = async () => {
    const res = await fetch(`https://social-media-app-next-8yy8s23ac-ksawerys-projects-dafd64ce.vercel.app/api/friend-invitation`, {
      headers: {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <p className='mt-2 text-base text-center border-t border-b border-t-[#222] border-b-[#111] py-2'>{props.username}</p>
      <div className='flex flex-col'>
        {props.type === 'Pending' ?
          <>
